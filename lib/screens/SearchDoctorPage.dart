...
class _SearchdoctorpageState extends State<Searchdoctorpage> {
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ListView(
                        ...
                        padding: const EdgeInsets.symmetric(horizontal: 10), // Added padding for better look
                        children: [
                          _buildSingleCategoryCard(
                              title: 'General',
                              categoryKey: 'General',
                              color: Color(0xff4cd1bc),
                              lightColor: Color(0xff5ed6c3)),
                          _buildSingleCategoryCard(
                              title: 'Skin',
                              categoryKey: 'Skin',
                              color: Color(0xff71b4fb),
                              lightColor: Color(0xff7fbcfb)),
                          _buildSingleCategoryCard(
                              title: 'Bones',
                              categoryKey: 'Bones',
                              color: Color(0xfffa8c73),
                              lightColor: Color(0xfffa9881)),
                          _buildSingleCategoryCard(
                              title: 'Child',
                              categoryKey: 'Child',
                              color: Color(0xff8873f4),
                              lightColor: Color(0xff9489f4)),
                        ],
                      ),
                    ),
                    Padding(
  ...
  Widget _buildSingleCategoryCard({
    ...
    // FIX: Replaced Expanded with Container and added a width
    return Container(
      width: 140, // Fixed width allows scrolling in ListView
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) =>
                  DoctorListPage(title: title, category: categoryKey),
            ),
          );
        },
        child: FutureBuilder<int>(
          ...
          builder: (context, snapshot) {
            ...
            return Components().categoryCard(title, countText, // Passed as the subtitle
                color: color,
